...
class ChargingSession(Base):
    ...
    start_ts: Mapped[str] = mapped_column(String(64), nullable=False)
    end_ts: Mapped[str] = mapped_column(String(64), nullable=False)
...
class BatchAnchor(Base):
    ...
    session_prefix: Mapped[str | None] = mapped_column(String(128))
